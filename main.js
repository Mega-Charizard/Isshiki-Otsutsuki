...
function take_snapshot()
{
 ...
 function speak()
 {
    prediction_1 = document.getElementById("result_emotion_name").innerHTML;
...
function check()
 ...
 function gotResult(error,results)
 {
     ...
     else 
     {
         ...
         if(results[0].label == "amazing, unlike Alex from school and not big Alex")
         {
            document.getElementById("update_emoji").innerHTML = "&#128077;";
         }

         if(results[0].label == "look a crocodile with a duck bill, and bull horns")
         {
            document.getElementById("update_emoji").innerHTML = "&#128073;";
         }

         if(results[1].label == "no just no")
         {
